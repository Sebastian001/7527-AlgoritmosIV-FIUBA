       ...
       select in-clientes
           assign to disk "../files-indexed/clientes.txt"
           organization is line sequential
           file status is fs-in-clientes.

       select out-clientes-seq
           assign to disk "../files-indexed/clientes.dat"
       ...
       select in-choferes
           assign to disk "../files-plain/choferes.txt"
           organization is line sequential
           file status is fs-in-choferes.

       select out-choferes-seq
           assign to disk "../files-plain/choferes.dat"
           organization is indexed
           access mode is sequential
       ...
       select in-alquileres
           assign to disk "../files-plain/alquileres.txt"
           organization is line sequential
           file status is fs-in-alquileres.

       select out-alquileres-seq
           assign to disk "../files-indexed/alquileres.dat"
           organization is indexed
           access mode is sequential
